...
public class irk_past_quetion_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_irk_past_quetion);



        ImageView imageView = findViewById(R.id.back_image_irk);
        ...
        ListView listView = findViewById(R.id.listview_irk);
