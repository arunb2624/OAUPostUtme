...
public class current_affairs_past_question_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_current_affairs_past_question);

        ImageView imageView = findViewById(R.id.back_image_current);
        ...
        ListView listView = findViewById(R.id.listview_current);
