...
public class litrature_past_question_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_litrature_past_question);

        ImageView imageView = findViewById(R.id.back_image_litrature);
        ...
        ListView listView = findViewById(R.id.listview_litrature);
