...
public class geogrephy_past_question_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_geogrephy_past_question);

        ImageView imageView = findViewById(R.id.back_image_geogreghy);
        ...
        ListView listView = findViewById(R.id.listview_geography);
