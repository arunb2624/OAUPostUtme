...
public class calculator_year_3 extends AppCompatActivity implements  View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calculator_year3);
        ...
        ba = (ImageView) findViewById(R.id.back_13);


        result = findViewById(R.id.result_tv13);
        solution = findViewById(R.id.solution_tv13);
