...
public class calculator_account_year1 extends AppCompatActivity implements  View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calculator_account_year1);




        ba = (ImageView) findViewById(R.id.back_);
